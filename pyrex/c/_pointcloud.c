/* Generated by Pyrex 0.9.8.5 on Sun Feb  8 11:51:47 2009 */
...
static char __pyx_k1[] = "Failed to write data point into point cloud file";
...
static PyObject *__pyx_f_11_pointcloud_readDataPoints(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":77 */
  __pyx_v_n = 0;

  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":78 */
  while (1) {
    ...
    /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":83 */
  ...
  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":89 */
  __pyx_2 = PyInt_FromLong(__pyx_v_n); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_11_pointcloud_writeDataPoints(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":108 */
  __pyx_v_pointCloud = ((__pyx_t_11_pointcloud_PtcPointCloud)__pyx_v_ptcHandle);
  ...
  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":120 */
  __pyx_v_dataPtr = ((float *)__pyx_v_dataBuf);
  ...
  while (1) {
    ...
    /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":126 */
    __pyx_1 = (__pyx_v_res == 0);
    if (__pyx_1) {
      ...
      __pyx_3 = PyObject_CallObject(PyExc_IOError, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; goto __pyx_L1;}
    ...
    /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":132 */
    __pyx_v_n += 1;
  }
...
PyMODINIT_FUNC init_pointcloud(void) {
  ...
  /* "/Users/baas/src/cgkit/pyrex/pyx/_pointcloud.pyx":91 */
  return;
  __pyx_L1:;
